...
/**
 * Geschäftslogik der Chat-Engine (API.md §9–10, ADR-005). **Lesen** (M5 Slice 2): Sidebar-Liste,
 * Detail, Verlauf, Ungelesen-Zähler. Zugriff ist **mitgliedschaftsgetrieben** (BOLA, ADR-004): DM über
 ...
 * Ungelesen-Watermark. Writes folgen in Slice 3.
 */
