...
export function MeetupCard({ meetup }: { meetup: MeetupListItem }) {
  ...
  return (
    <Card className="flex h-full flex-col overflow-hidden shadow-hover">
      ...
      <div className="flex flex-1 flex-col p-4.5">
        <span className="mb-2 w-fit rounded-full border-[1.5px] border-base-300 px-3 py-1 text-xs font-semibold whitespace-nowrap">
